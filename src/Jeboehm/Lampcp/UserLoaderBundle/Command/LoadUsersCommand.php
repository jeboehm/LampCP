...
class LoadUsersCommand extends AbstractCommand {
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		$this->_localUserRepository = $this->_getDoctrine()->getRepository('JeboehmLampcpCoreBundle:User');
		$this->_domainRepository    = $this->_getDoctrine()->getRepository('JeboehmLampcpCoreBundle:Domain');
